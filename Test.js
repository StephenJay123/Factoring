...
const questions = [
    "x² + 5x + 6",       // Factorable as (x + 2)(x + 3)
    "x² + 4x + 4",       // Factorable as (x + 2)(x + 2)
    "x² + 7x + 10",      // Factorable as (x + 5)(x + 2)
    "x² + 8x + 15",      // Factorable as (x + 3)(x + 5)
    "x² + 3x + 2",       // Factorable as (x + 1)(x + 2)
    "x² + 6x + 5",       // Factorable as (x + 1)(x + 5)
    "x² + 2x - 3",       // Factorable as (x + 3)(x - 1)
    "x² + 10x + 24",     // Factorable as (x + 4)(x + 6)
    "x² + 9x + 20",      // Factorable as (x + 4)(x + 5)
    "x² + 12x + 36",     // Factorable as (x + 6)(x + 6)

    // Hard Trinomials
    "2x² + 7x + 10",     // Factorable as (2x + 1)(x + 5)
    "3x² + 8x + 4",      // Factorable as (3x + 4)(x + 1)
    "4x² + 11x + 5",     // Factorable as (4x + 1)(x + 5)
    "2x² + 9x + 7",      // Factorable as (2x + 7)(x + 1)
    "3x² + 13x + 12",    // Factorable as (3x + 4)(x + 3)
    "5x² + 19x + 12",    // Factorable as (5x + 4)(x + 3)
    "6x² + 13x + 6",     // Factorable as (3x + 2)(2x + 3)
    "5x² + 20x + 16",    // Factorable as (5x + 4)(x + 4)
    "4x² + 15x + 9",     // Factorable as (4x + 3)(x + 3)
    "2x² + 5x + 3",      // Factorable as (2x + 3)(x + 1)

    // Difference of Squares
    "x² - 9",            // Factorable as (x - 3)(x + 3)
    "4x² - 25",          // Factorable as (2x - 5)(2x + 5)
    "9x² - 16",          // Factorable as (3x - 4)(3x + 4)
    "16x² - 81",         // Factorable as (4x - 9)(4x + 9)
    "25x² - 49",         // Factorable as (5x - 7)(5x + 7)
    "36x² - 64",         // Factorable as (6x - 8)(6x + 8)
    "81x² - 1",          // Factorable as (9x - 1)(9x + 1)
    "49x² - 121",        // Factorable as (7x - 11)(7x + 11)
    "64x² - 100",        // Factorable as (8x - 10)(8x + 10)
    "100x² - 81",        // Factorable as (10x - 9)(10x + 9)

    // Perfect Square Trinomials
    "x² + 6x + 9",       // Factorable as (x + 3)(x + 3)
    "4x² + 12x + 9",     // Factorable as (2x + 3)(2x + 3)
    "9x² + 24x + 16",    // Factorable as (3x + 4)(3x + 4)
    "16x² + 24x + 9",    // Factorable as (4x + 3)(4x + 3)
    "25x² + 30x + 9",    // Factorable as (5x + 3)(5x + 3)
    "36x² + 72x + 36",   // Factorable as (6x + 6)(6x + 6)
    "49x² + 42x + 9",    // Factorable as (7x + 3)(7x + 3)
    "64x² + 64x + 16",   // Factorable as (8x + 4)(8x + 4)
    "81x² + 72x + 16",   // Factorable as (9x + 4)(9x + 4)
    "100x² + 80x + 16"   // Factorable as (10x + 4)(10x + 4)
];
